...
// $input_imagem_perfil = trim($_POST['input_imagem_perfil']);
...
//     VALUES ('$id_usuario', '$habilidades', '$pretencao_salarial', '$nivel', '$cidade', '$endereco_principal','$endereco_secundario','$estado','$telefone_primario','$telefone_secundario','$data_nascimento','$nivel_ingles','$url_linkedin', '$input_imagem_perfil')";

//     if($conexao->query($sql_insert_competencias) === TRUE and $conexao->query($sql_update_user) === TRUE){
//         $arquivo_imagem = 'images/profile_images/' . $row_informacoes_competencia['imagem'];
